    ...
    <main class="container my-5">
        ...
        @if (session('username'))
            <div class="alert alert-primary text-center">
                Selamat datang, {{ session('username') }}! <br>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <ul class="list-group text-start">
                            ...
                            <li class="list-group-item"><strong>Tanggal Harus Wisuda:</strong> {{ $tgl_harus_wisuda }}
                            </li>
                            <li class="list-group-item"><strong>Sisa Waktu Studi:</strong> {{ $time_to_study_left }}
                                hari</li>
                            <li class="list-group-item"><strong>Semester Saat Ini:</strong> {{ $current_semester }}
                            </li>
                            <li class="list-group-item"><strong>Informasi:</strong> {{ $info }}</li>
